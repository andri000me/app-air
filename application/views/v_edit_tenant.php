            ...
            <div class="row col-md-5">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><input class="form-control" type="text" name="nama_tenant" id="nama_tenant" required value="<?php echo $isi['nama_tenant'] ?>"></td>
                    </tr>
                    <tr>
                        <td><label>Penanggung Jawab</label></td>
                        <td>:</td>
                        <td><input class="form-control" type="text" name="penanggung_jawab" id="penanggung_jawab" required value="<?php echo $isi['penanggung_jawab'] ?>"></td>
                    </tr>
                    <tr>
                            ...
                            <select class="form-control" name="id_flowmeter" id="id_flowmeter">
                                <?php foreach ($tenant as $row) {
                                    if($row->id_flow == $isi['id_flowmeter']) {
                                        ?>
                                        <option selected value="<?php echo $row->id_flow ?>"><?php echo $row->id_flowmeter ?>
                                            => <?php echo $row->nama_flowmeter ?></option>
                                        <?php
                                    }else{
                                        ?>
                                        <option value="<?php echo $row->id_flow ?>"><?php echo $row->id_flowmeter ?>
                                        => <?php echo $row->nama_flowmeter ?></option>
                                        <?php
                                    }
                                }
                            ...
                            <select class="form-control" name="id_lumpsum" id="id_lumpsum">
                                ...
                                <?php foreach ($tenant as $row) {
                                    if($row->id_lumpsum == $isi['id_lumpsum']) {
                                        ?>
                                        <option selected value="<?php echo $row->id_lumpsum ?>"><?php echo $row->id_lumpsum ?>
                                            => <?php echo $row->no_perjanjian ?></option>
                                        <?php
                                    }else{
                                        ?>
                                        <option value="<?php echo $row->id_lumpsum ?>"><?php echo $row->id_lumpsum ?>
                                            => <?php echo $row->no_perjanjian ?></option>
                                        <?php
                                    }
                                }
