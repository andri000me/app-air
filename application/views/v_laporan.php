    ...
    <script>
        ...
        function search() {
            ...
            var $new_tabel = $("<div id='tabel-laporan'></div>"),
                ...
                existingdiv1 = document.getElementById("tabel");
            $.ajax({
                url: "<?= base_url('main/laporan_ruko_keuangan')?>",
                method: "POST",
                data: {
                    tgl_awal: tgl_awal,
                    tgl_akhir: tgl_akhir
...
<?php
    ...
    <script>
        ...
        function search() {
            ...
            var $new_tabel = $("<div id='tabel-laporan'></div>"),
                ...
                existingdiv1 = document.getElementById("tabel");
            $.ajax({
                url: "<?= base_url('main/laporan_flow')?>",
                method: "POST",
                data: {
                    tgl_awal: tgl_awal,
                    tgl_akhir: tgl_akhir
    ...
    <div class="container container-fluid">
        <h3>Pembuatan Laporan Pencatatan Flow Meter</h3><br><br>
        <div class="row col-sm-6">
            <table class="table table-responsive table-condensed">
                <tr>
                    <td>
    ...
    <script>
        ...
        function search() {
            ...
            var $new_tabel = $("<div id='tabel-laporan'></div>"),
                ...
                existingdiv1 = document.getElementById("tabel");
            $.ajax({
                url: "<?= base_url('main/laporan_sumur')?>",
                method: "POST",
                data: {
                    tgl_awal: tgl_awal,
                    tgl_akhir: tgl_akhir
