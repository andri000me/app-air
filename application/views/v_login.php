...
<div class="container container-fluid">
        ...
        <br>
        <div>
            <center><a href="<?php if(isset($_SESSION['authUrl'])) echo $_SESSION['authUrl']; ?>"><img id="google_signin" src="<?php echo base_url(); ?>images/google_login.jpg" width="100%" ></a></center>
        </div>
    </div>