<script type="text/javascript">
    ...
    xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            var a = "<thead>" +
                ...
                "<th><center>Waktu Selesai Pengisian</center></th>" +
            ...
            while (i < myArr.length) {
                a += "<tr>" +
                    ...
                    "<td align='center'>" + myArr[i]["waktu_selesai_pelayanan"] + "</td>" +
    ...
    function save() {
        ...
        url = "<?php echo site_url('kapal/realisasi_pembayaran_laut')?>";
...
<body>
    <div class="container container-fluid">
        <div class="row">
            <center><h4>Daftar Tagihan Pelayanan Jasa Air Bersih Untuk Kapal (Piutang)</h4></center>
            <br>
