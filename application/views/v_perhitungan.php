...
$this->fpdf->Cell(40, 7, 'ID LCT', 0, 'L');
$this->fpdf->Cell(5, 7, ':', 0, 'L');
$this->fpdf->Cell(70, 7, $hasil['id_lct'], 0, 'L');
$this->fpdf->Ln();
$this->fpdf->Cell(40, 7, 'Nama LCT', 0, 'L');
$this->fpdf->Cell(5, 7, ':', 0, 'L');
$this->fpdf->Cell(70, 7, $hasil['nama_kapal'], 0, 'L');
$this->fpdf->Ln();
...
$this->fpdf->Ln();
$this->fpdf->Ln();
$this->fpdf->Cell(180, 3, 'DASAR PENGENAAN PAJAK (DPP)   :',  0, 0, 'R');
$this->fpdf->Cell(50, 3, 'Rp. '.$hasil['total'],  0, 0, 'R');
$this->fpdf->Ln(8);
$this->fpdf->Cell(180, 3, 'PPN (10%)   :',  0, 0, 'R');
$this->fpdf->Cell(50, 3, '0,-',  0, 0, 'R');
$this->fpdf->Ln(8);
$this->fpdf->Cell(180, 3, 'MATERAI   :',  0, 0, 'R');
$this->fpdf->Cell(50, 3, 'Rp. '.$hasil['materai'],  0, 0, 'R');
$this->fpdf->Ln(8);
$this->fpdf->Cell(180, 3, 'JUMLAH DIBAYAR   :',  0, 0, 'R');
