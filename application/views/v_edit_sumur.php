<script type="text/javascript">
    $(document).ready(function (e) {
        $('#upload_doku').on('click', function () {
            ...
            form_data.append('debit_air',debit);
            ...
            <div class="row col-md-5">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><input class="form-control" type="text" name="debit_air" id="debit_air" required value="<?php echo $isi['debit_air'] ?>"></td>
                    </tr>
                    <tr>
                        <td colspan="3">
