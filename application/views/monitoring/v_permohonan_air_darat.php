...
<div class="container container-fluid">
    <div class="row">
        <script type="text/javascript">
            ...
            xmlhttp.open("GET", "<?php echo base_url("darat/tabel_pembayaran")?>", true);
            xmlhttp.send();
        </script>
        <body>
        <div class="container container-fluid">
                ...
                if (confirm('Batalkan Transaksi ?')) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            window.location.replace('<?php echo base_url('main/monitoring/permohonan_air_darat');?>');
                        },
        ...
        <script>
            function cancel_kwitansi(id){
                var url;
                var id = id;
                url = "<?php echo site_url('darat/cancelKwitansi')?>";
